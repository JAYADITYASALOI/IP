...
<div class="container">
    ...
    <main style="padding:16px 0;">
        ...
        <form method="post" action="${pageContext.request.contextPath}/register" style="max-width:520px;">
            ...
            <div style="margin-bottom:8px;">
                ...
                <input id="fullName" name="fullName" type="text" style="width:100%;padding:8px;"/>
            </div>
            <div style="margin-bottom:8px;">
            ...
            <div>
                ...
                <a href="${pageContext.request.contextPath}/login" style="margin-left:12px;">Already have an account?</a>
            </div>
        </form>
    </main>
